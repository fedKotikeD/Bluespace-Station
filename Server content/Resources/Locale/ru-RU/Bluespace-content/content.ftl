...
reagent-name-geneticKiller = Специальное уникальное медицинское средство, которое уничтожает ваши клетки. Одной таблетки достаточно чтобы умереть. Но все ученые одного мнения: "НЕ ПЕЙТЕ ЭТУ ЧЕРТОВУ ДРЯНЬ!"