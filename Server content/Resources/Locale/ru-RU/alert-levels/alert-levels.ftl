...
alert-level-alpha-announcement = Со станции сняты любые ограничения по корпоративному закону и СРП. Любые нарушение, в том числе убийства, легализованы. Служба безопасности более не валидна и подлежит уничтожению.
