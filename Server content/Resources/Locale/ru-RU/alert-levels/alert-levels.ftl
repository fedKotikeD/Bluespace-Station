...
alert-level-vinous = Бордовый
alert-level-vinous-announcement = Власть была захвачена синдикатом. Теперь эта станция подвержена указам ядерных оперативников. Агенты синдиката наделены властью. Командование уволено. Слава синдикату!
alert-level-brown = Коричневый
alert-level-brown-announcement = Революция была проведена успешно. Командование станции свергнуто или убито. Все обязаны подчиняться революционерам. Правителем объявляется глава революции!